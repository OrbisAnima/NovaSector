...
/obj/structure/lewd_portal
	...
	icon = 'modular_nova/modules/modular_items/lewd_items/icons/obj/lewd_structures/lewd_portals.dmi'
	icon_state = "portal"
	can_buckle = TRUE
	anchored = TRUE
	max_buckled_mobs = 1
...
/obj/lewd_portal_relay/proc/lower_body_only()
	...
	if(owner.w_uniform)
		...
		uniform_overlay.add_filter("upper_body_removal", 1, list("type" = "alpha", "icon" = icon('modular_nova/modules/modular_items/lewd_items/icons/obj/lewd_structures/lewd_portals.dmi', "mask")))
	...
	for(var/image/body_layer_overlay in owner.overlays_standing[BODY_LAYER])
		...
		new_body_layer_overlay.add_filter("upper_body_removal", 1, list("type" = "alpha", "icon" = icon('modular_nova/modules/modular_items/lewd_items/icons/obj/lewd_structures/lewd_portals.dmi', "mask")))
...
/obj/lewd_portal_relay/proc/torso_only(limb_icon_list)
	...
	for(var/image/limb_icon in limb_icon_list)
		...
		if(limb_icon_layer != BODY_BEHIND_LAYER && limb_icon_layer != BODY_FRONT_LAYER || compare_organ_icon(ORGAN_SLOT_BREASTS, limb_icon.icon)) //Tails need to be portaled
			limb_icon.add_filter("upper_body_removal", 1, list("type" = "alpha", "icon" = icon('modular_nova/modules/modular_items/lewd_items/icons/obj/lewd_structures/lewd_portals.dmi', "mask")))
